...
![Build Status](https://github.com/NCourse/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
You should use the template to start your DevOps Capstone project. It contains all of the code that you will need to get started.
